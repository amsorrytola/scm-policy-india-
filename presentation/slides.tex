...
% ── tcolorbox styles (tighter padding to save vertical space) ───────────────
\tcbset{
  navybox/.style={
    ...
    attach boxed title to top left={yshift=-1.6mm,xshift=4mm},
    boxed title style={colback=NavyPrimary,arc=2pt,boxrule=0pt}
  },
  amberbox/.style={
  ...
  greenbox/.style={
    ...
    fonttitle=\footnotesize\bfseries\color{white}, coltitle=white,
    attach boxed title to top left={yshift=-1.6mm,xshift=4mm},
    boxed title style={colback=SuccessGreen!70,arc=2pt,boxrule=0pt}
  },
  redbox/.style={
    ...
    fonttitle=\footnotesize\bfseries\color{white}, coltitle=white,
    attach boxed title to top left={yshift=-1.6mm,xshift=4mm},
    boxed title style={colback=DangerRed!60,arc=2pt,boxrule=0pt}
  },
  statbox/.style={
    colback=NavyPrimary, colframe=NavyDark,
    boxrule=0pt, arc=4pt, left=4pt, right=4pt, top=3pt, bottom=3pt,
    halign=center, fontupper=\color{white}
  },
  graybox/.style={
    colback=GrayLight!40, colframe=GrayMid,
    boxrule=0.5pt, arc=3pt, left=3pt, right=3pt, top=2pt, bottom=2pt
  }
}
  ...
  \begin{tcolorbox}[navybox,title={\faBookOpen\enspace Methodology}]
    ...
    \begin{itemize}
      \item Abadie, A., Diamond, A., \& Hainmueller, J.\ (2010). Synthetic
            Control Methods for Comparative Case Studies. \emph{JASA}, 105(490), 493--505.
      \item Abadie, A., Diamond, A., \& Hainmueller, J.\ (2015). Comparative
            Politics and the Synthetic Control Method. \emph{AJPS}, 59(2), 495--510.
      \item Abadie, A.\ (2021). Using Synthetic Controls. \emph{JEL}, 59(2), 391--425.
      \item Brodersen, K.\ et al.\ (2015). Inferring Causal Impact Using
            Bayesian Structural Time-Series Models. \emph{AOAS}, 9(1), 247--274.
      \item Doudchenko, N., \& Imbens, G.\ (2016). Balancing, Regression, DiD
            and Synthetic Control. \emph{NBER WP} 22791.
    \end{itemize}
  \end{tcolorbox}
